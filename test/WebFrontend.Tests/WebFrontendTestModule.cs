...
namespace WebFrontend.Tests
{
    ...
    public class WebFrontendTestModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(WebFrontendTestModule).GetAssembly());
        }
        ...
        private void SetupInMemoryDb()
        {
            ...
            IocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<WebFrontendDbContext>>()
